...
function getIconItem(e, n) {
    var o = document.createElement("div"),
        ...
        a = (o.className = "col-sm-6 col-md-4 col-lg-3", a.className = "mdi mdi-" + e.name, o.appendChild(a), document.createElement("span"));
    ...
    e.push({
        ...
        document.getElementById("icons").appendChild(n), isNew(e) && (n = getIconItem(e, !1, !1), document.getElementById("newIcons").appendChild(n), 0), 0
    })
}();